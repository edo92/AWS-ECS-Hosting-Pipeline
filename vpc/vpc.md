...
<table style="padding-top: 15px; padding-bottom: 15px">
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#elastic-ip"
        >Elastic IP</a
      >
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#additional-public-subnet"
  ...
  <tr>
     <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#lunch-vpc-wizard"
        >VPC Wizard</a
      >
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#additional-private-subnet"
...
<table style="padding-top: 15px; padding-bottom: 15px">
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#change-public-subnet-2-route-table-association"
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#route-tables-subnet-association"
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#subnet-route-table-association-target"
 ...
 **` In order to create VPC we will need elastic ip, which is reserved public IP address that vpc uses`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-elasticip.png"/>
  </p>

- **`Allocate Elastic Ip Address`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-allocationEI.png" height="650px"/>
  </p>
...
- **`Lunch wizard`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-lunch-wizard.png"/>
  </p>

- **`VPC with private and public Subnets`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-wizard-start.png" />
  </p>
...
- **`Configure VPC Wizard, Create VPC`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-private_public-subnets.png"/>
  </p>
...
- **`Successful VPC creation`**\
  ...
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-create-success.png" height="450px"/>
  </p>
...
- **`Create additional Private and public subnets`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-create-additional-subnets.png"/>
  </p>

> **_NOTE:_** Wizard Created Subnets On `us-east-2c` Availibility Zone
> ![alt text](https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/ecs-vpc-wizard-subnet-availibility-zone.png)
...
- **`Create Public subnet 2 that has ip 10.0.2.0/24`**\
  **_NOTE:_** Select Availibility Zone different than `us-east-2c`, which is in use by other 2 subnets\
  ...
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-additional-public-ip.png" height="650px"/>
  </p>
...
- **`Create Private subnet 2 that has ip 10.0.3.0/24`**\
  ...
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-additional-private-ip.png" height="650px"/>
  </p>
<br/>
...
- **`You end up with this result`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-end-result-dashboard.png"/>
  </p>
...
- **`Edit route table association of newly Created Public Subnet to point to igw-xxxxx`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-configure-route-tables.png"/>
  </p>
...
- **Private subnets route table must point to nat-xxxxx**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-publicip-association.png" height="650px"/>
  </p>
...
- **`Public Route Tables must have Target Network as iwg-xxxxx`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-public-target-network.png"/>
  </p>
...
- **`Private Route Tables must have Target Network as nat-xxxxx`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-private-target-network.png"/>
  </p>
...
- **`Public Route Table Edit Subnet association`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-public-subnet-assoc-edit.png"/>
  </p>

- **`Select all Public Subnets in the table`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-public-subnet-assoc-table.png"/>
  </p>
...
- **`Private Route Table Edit Subnet association`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-private-subnet-assoc-edit.png"/>
  </p>

- **`Select all Public Subnets in the table`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/vpc/images/vpc-route-table-private-subnet-assoc-table.png"/>
  </p>
