...
<table style="padding-top: 15px; padding-bottom: 15px">
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#create-cluster"
        >Cluster Template</a
      >
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#create-service-for-ecs-cluster"
        >Configure Service</a
      >
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#configure-cluster"
        >Configure Cluster</a
      >
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#service-deployment-configuration"
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#networking-configuration"
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#load-balancer-configuration"
        >Load Balancer</a
      >
  ...
  <tr>
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#ecs-iam-role"
    ...
    <td>
      <a
        href="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/ecscluster.md#container-to-load-balancer"
...
- **`Create Cluster In ECS`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-create-cluster.png"/>
  </p>
...
- **`Select Cluster Template, ECS Linux + Networking`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-template.png" height="500px"/>
  </p>
...
- **`Give a Cluster name, and select (t2.small) `** [EC2 instace type](https://aws.amazon.com/ec2/instance-types/)\
  **`Give Number of Instances (home many instances to run)`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-config.png" height="500px"/>
  </p>
...
- **`Configure Networking, Select`** [VPC that we created](https://github.com/cyber-netics/testX/blob/main/.assets/vpc/vpc.md#steps)\
  ...
  **`Select Security Group Created in Above Step`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-networking.png" height="650px" width="100%"/>
  </p>

<br/>

> **_NOTE:_**  **In above step Select Security Group that we created for ECS**
> ![alt text](https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-select-sg.png)
...
- **`Select Container Instace IAM Role, If don't have one Select Create New Role`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-create-cluster-rest.png" height="550px"/>
  </p>
...
- **`Now we can see created cluster in the list`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-dashboard.png"/>
  </p>
...
- **`Click on Create`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-create-cluster-service.png"/>
  </p>
...
- **`ECS Cluster Service Config`**\
  ...
  **`Number of Tasks to be created: 1`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-config.png" height="550px"/>
  </p>
...
- **`Deployment Configuration`**\
  ...
  **`Select Role For CodeBuild. Code Build Role that we just created`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-deployment.png"/>
  </p>
...
- **`Task Placement Leave as default, Next`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-task-placement-default.png"/>
  </p>
...
- **`Set Load Balancer for ECS Cluster Service`**\
  ...
  **`Select Load Balancer, just created in this section`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-loadbalancer-config.png" height="900px"/>
  </p>
...
- **`Once You Click Add to Load Balancer Container Load Balance will appear`** \
  ...
  **`You can add another port for test listener otherwise Unmark Test listener`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-loadbalancer-config-addto-lb.png"/>
  </p>
...
- **`Additional Configuration`**\
  ...
  **`Select Create New for Target Group 2, Give Name TG2`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-additional-config.png"/>
  </p>
...
- **`Leave Auto Scaling Default (we can add later)`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-autoscaling.png"/>
  </p>
...
- **`Confirm and Create Service`**
  <p align="center">
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-config-review.png" height="700"/>
  </p>
...
- **`In the Cluster we can see Service has been created`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-service-list.png"/>
  </p>
...
- **`In Cluster Under Tasks you can see Task has been created`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-tasks-created.png"/>
  </p>
...
- **`In Cluster Under Event you can see steps. service MyApp-Service has reached a steady state means it successfuly updated ECS`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-task-event.png"/>
  </p>
...
- **`In VPC -> Target Groups, Under TG1 you can see Load Balancer Registered Target, and status is healthy`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-target-group-registered-target.png"/>
  </p>
...
- **`In VPC -> Load Balancer, Under Basic Configuration we can copy DNS name which is the url for the website`**
  <p>
    <img src="https://github.com/cyber-netics/testX/blob/main/.assets/ecs/images/ecscluster/ecs-cluster-lb-dnas-name.png"/>
  </p>
